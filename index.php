...
<head>
	...
	<title>Selinggo-Net</title>
	<link rel="icon" href="dist/img/komp.svg">
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">
					<marquee>
						<b>APLIKASI TAGIHAN SELINGGO-NET</b>
					</marquee>
				</span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu">
							<a class="dropdown-toggle">
								<span>
									<b>
										APLIKASI TAGIHAN SELINGGO-NET (PAKET BULANAN)
									</b>
								</span>
							</a>
						</li>
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="dist/img/komp.svg" class="" alt="User Image">
					</div>
		...
		<footer class="main-footer">
			...
			<center>
				<strong>Copyright &copy;
					<a href="http://www.suratulem.com/">Selinggo-Net</a>.</strong> All rights reserved.
			</center>
		</footer>
